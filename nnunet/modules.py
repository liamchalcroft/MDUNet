...
from drop import DropPath, trunc_normal_
import math
...
class MDBlock(nn.Module):
    def __init__(self, img_size, in_chans, embed_chans, patch_size=3, stride=2,
                        num_units=1, dropout=0., mlp_ratio=4, path_dropout=0.,
                        norm_layer=nn.LayerNorm, transpose=False):
        ...
        self.layers = nn.ModuleList([Block(
            dim=embed_chans, mlp_ratio=mlp_ratio, drop=dropout, drop_path=path_dropout[i])
